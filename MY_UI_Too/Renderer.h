...
namespace MY_UI_Too{
	...
	public:
		...
		// the four draw functions below only buffer the data, they do not actually draw anything until DrawBuffred is called
			...
			virtual void DrawTextCaret_NoClip(const MY_UI_Too::Interfaces::ITexture* pTexture, const MY_UI_Too::Interfaces::IFont* font, const std::string txt,const MY_UI_Too::Utilities::Point startinpos, const  unsigned int fontsize, unsigned int carentindex, const  MY_UI_Too::Utilities::Color color_tl = MY_UI_Too::Utilities::White,const  MY_UI_Too::Utilities::Color color_tr = MY_UI_Too::Utilities::White,const  MY_UI_Too::Utilities::Color color_bl = MY_UI_Too::Utilities::White, const MY_UI_Too::Utilities::Color color_br = MY_UI_Too::Utilities::White, bool getnewbuffer=false);
