...
namespace MY_UI_Too{
	namespace Interfaces{
		...
		public:
			...
			virtual MY_UI_Too::Utilities::Point Measure_String(MY_UI_Too::Utilities::Point skinsize, MY_UI_Too::Interfaces::IFont* font, unsigned int fontsize, std::string text)=0;
		...
		protected:
			...
			virtual bool SetTexture(MY_UI_Too::Interfaces::ITexture* pTexture, bool getnewbuffer)=0;
